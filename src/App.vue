...
<form @submit.prevent="addTodo">
  <div class="field">
    <div class="control">
      <input type="text" v-model="todo" class="input is-primary" placeholder="Todo girin" style="width:300px">
    </div>
  </div>
...
<div class="card-content">
  <div class="media">
    ...
    <div class="media-content">
      <p class="title cursor" @click="done(todo)" :class="{done: todo.done}">{{ todo.content }}</p>
